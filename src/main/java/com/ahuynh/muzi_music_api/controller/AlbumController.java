...
public class AlbumController {
    ...
    public ResponseEntity<?> getAlbum(@PathVariable(name = "id") Long id) {
        ...
        return new ResponseEntity<>(new ApiResponse(true, "Successfully", objectMapper.convertValue(album, Album.class)), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> updateAlbum(@PathVariable(name = "id") Long id, @RequestBody AlbumRequest newAlbum) {
        ...
        return new ResponseEntity<>(new ApiResponse(true, "Update album Successfully", objectMapper.convertValue(album, Album.class)), HttpStatus.OK);
    }
